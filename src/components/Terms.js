  ...
  return (
    <div className="bg-white px-6 py-32 lg:px-8">
      <div class="max-w-2xl mx-auto my-10 p-6 bg-white rounded-md shadow-md text-gray-900">
        ...
        <h2 class="text-xl font-bold text-gray-900 mb-2">3. Use of the App</h2>
        <ul class="list-disc pl-5 text-gray-700 mb-6">
          <li class="mb-1">
            You must be at least 18 years old to use the App, or the legal age
          ...
          <li class="mb-1">
            ...
            purpose, and you will not violate any applicable laws while using
            the App.
          </li>
          <li class="mb-1">
        ...
        <h2 class="text-xl font-bold text-gray-900 mb-2">4. Privacy</h2>
        <p class="text-gray-700 mb-6">
        ...
        <ul class="list-disc pl-5 text-gray-700 mb-6">
          ...
          <li class="mb-1">
            ...
            works of the App without our prior written consent.
          </li>
        </ul>
        ...
        <ul class="list-disc pl-5 text-gray-700 mb-6">
          ...
          <li class="mb-1">
            The information provided through the App is for informational
        ...
        <ul class="list-disc pl-5 mb-6">
          <li class="mb-1">Your use or inability to use the App.</li>
          <li class="mb-1">
          ...
          <li class="mb-1">
            ...
            emailed, transmitted, or otherwise made available through the App,
            whether based on warranty, contract, tort, or any other legal
            theory.
          </li>
        </ul>

        <h2 class="text-xl font-bold text-gray-900 mb-2">8. Governing Law</h2>
        <p class="text-gray-700 mb-6">
          These TOS are governed by and construed in accordance with the laws of
          the Commonwealth of Virginia, without regard to its conflict of law
          principles.
        </p>
